...
public class LoadPuzzleGame : MonoBehaviour {
    ...
    public LayoutPuzzleButtons layoutPuzzleButtons;
    public PuzzleGameManager puzzleGameManager;
    public LevelLocker levelLocker;

    public GameObject puzzleLevelSelectPanel;
    public GameObject puzzleGamePanel1, puzzleGamePanel2, puzzleGamePanel3, puzzleGamePanel4, puzzleGamePanel5;

    public Animator puzzleLevelSelectAnim;
    public Animator puzzleGamePanelAnim1, puzzleGamePanelAnim2, puzzleGamePanelAnim3, puzzleGamePanelAnim4, puzzleGamePanelAnim5;
